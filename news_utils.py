...
class NewsRetriever:
    ...
    def __init__(self):
        self.newsapiClient = NewsApiClient(api_key='0db407d03f954b2dae5d9a1620e34771')
        self.list_of_sources = "buzzfeed,bbc-news,fox-news,cnn,the-new-york-times,the-times-of-india,the-wall-street-journal,the-washington-post"
